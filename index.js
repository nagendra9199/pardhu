    ...
    <div class="detailed-view-bg-container">
        ...
        <div class="detailed-view-card">
            <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/6TtYB3aqy1I?rel=0" allowfullscreen></iframe>
            </div>
            <div>
                <h1 class="detailed-view-head"> Taj Mahal </h1>
                <p class="detailed-view-para"> The Taj Mahal is considered to be the greatest architectural
